...
const fraseSecreta = FraseSecreta()
const sinRepetidos = ElimRepetidos(fraseSecreta)
const matriz = FraseAMatriz(sinRepetidos)
const frase = Frase()
const encriptado = Encriptador(matriz, frase, sinRepetidos.length-1)
console.log(matriz)
console.log(frase + '=>' + encriptado)